...
//                           .op("sparse::spmm_sum", &spmm_sum)
//                           .op("sparse::spmm_mean", &spmm_mean)
//                           .op("sparse::spmm_min", &spmm_min)
//                           .op("sparse::spmm_max", &spmm_max);
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("spmm_sum", &spmm_sum, "SPMM Sum");
    m.def("spmm_mean", &spmm_mean, "SPMM Mean");
    m.def("spmm_min", &spmm_min, "SPMM Min");
    m.def("spmm_max", &spmm_max, "SPMM Max");
