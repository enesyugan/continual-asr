...
//  using ActivationFnElementCompute = ActivationFn_<ElementCompute>;
  using ActivationFnElementCompute = cutlass::epilogue::thread::SiLu<ElementCompute>;
...
//  using ActivationFnFragmentCompute = ActivationFn_<FragmentCompute>;
  using ActivationFnFragmentCompute = cutlass::epilogue::thread::SiLu<FragmentCompute>;

  struct Params {};

 public:
  CUTLASS_HOST_DEVICE
  EpilogueLHSSiLUAndMul(Params const& /*params*/) {}
...
class EpilogueSum {
 ...
 public:
  CUTLASS_HOST_DEVICE
  EpilogueSum(Params const& /*params*/) {}
  ...
  FragmentOutput operator()(
    ...
    cutlass::plus<FragmentCompute> add_func;

    return compute_to_out(add_func(casted_lhs, casted_rhs));
  }
  ...
  ElementOutput operator()(
    ...
    cutlass::plus<ElementCompute> add_func;

    return ElementOutput(add_func(casted_lhs, casted_rhs));
  }
};